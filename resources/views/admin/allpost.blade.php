                            ...
                            <tbody>
                                ...
                                <tr style="border-bottom: 1px solid #ddd;">
                                    ...
                                    <td style="padding: 12px 15px;">
                                        <a href="{{route('admin.update', ['id' => $posts->id])}}" style="background-color: #2196F3; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer; margin-right: 5px;">Update</a>
                                    </td>
                                    <td style="padding: 12px 15px;">
                                        <form action="{{ route('admin.deletepost', $posts->id) }}" method="POST" style="display:inline;">
                                            @csrf
                                            <button type="submit" style="background-color: #f44336; color: white; border: none; padding: 6px 12px; border-radius: 4px; cursor: pointer;">Delete</button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
